...
import { _clientDeleteAction } from '../_data/actions/ClientActions'
...
export default function ClientPage({dbData}: PropInterface) {
    const {  
        search, 
        isSearching, 
        setSearch, 
...
function MainDataArea(){
    ...
    async function handleDelete(id: string | number){
        setIsLoading(true)
        try{
            const res = await _clientDeleteAction(id) 
