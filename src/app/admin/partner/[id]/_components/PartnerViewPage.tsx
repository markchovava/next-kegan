...
export default function PartnerViewPage({dbData}: PropInterface) {
    const { setData, setToggleModal } = usePartnerStore()
...
function DataMainArea() {
    const { preData, isLoading } = usePartnerStore()
    ...
    return(
      <section className='container__primary bg-white drop-shadow-lg rounded-lg p-6 space-y-4'>
        ...
        <RecordImage label='Image' value={preData.image} css='apsect-2/1' />
