...
import { _partnerDeleteAction } from '../_data/actions/PartnerActions'
...
export default function PartnerPage({dbData}: PropInterface) {
    const {  
        search, 
        isSearching, 
        setSearch, 
