...
import { FixedAssetData } from '../../_data/sample/ServiceData'
...
export async function generateMetadata(): Promise<Metadata> {
  const pageMeta = await getPageMeta('fixed-assets');

  if (!pageMeta?.data) {
    return {
      title: 'Kegan Management Consulting - Fixed Assets',
      description: '',
    };
  }
