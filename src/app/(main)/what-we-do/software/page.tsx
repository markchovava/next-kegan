...
import { FixedAssetData, SoftwareData } from '../../_data/sample/ServiceData'
...
export async function generateMetadata(): Promise<Metadata> {
  const pageMeta = await getPageMeta('software');

  if (!pageMeta?.data) {
    return {
      title: 'Kegan Management Consulting - Software',
      description: '',
    };
  }
